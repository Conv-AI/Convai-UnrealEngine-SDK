...
class GetResponseRequest_GetResponseConfig PROTOBUF_FINAL :
 ...
 public:
  ...
  void set_api_auth_token(const std::string& value);
  void set_api_auth_token(std::string&& value);
  void set_api_auth_token(const char* value);
  void set_api_auth_token(const char* value, size_t size);
  std::string* mutable_api_auth_token();
  std::string* release_api_auth_token();
  void set_allocated_api_auth_token(std::string* api_auth_token);
  private:
  const std::string& _internal_api_auth_token() const;
  void _internal_set_api_auth_token(const std::string& value);
...
class GetResponseResponse_AudioResponse PROTOBUF_FINAL :
 ...
 public:
  ...
  ::service::ARKitBlendShapesData* release_face_emotion();
  ...
  ::service::EmotionResponse* release_emotion_response();
...
class EmotionResponse PROTOBUF_FINAL :
 ...
 public:
  ...
  inline EmotionResponse* New() const final {
    return CreateMaybeMessage<EmotionResponse>(nullptr);
  }

  EmotionResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  void _internal_set_emotion(const std::string& value);
...
class FeedbackRequest PROTOBUF_FINAL :
 ...
 public:
  ...
  void set_user_query(const std::string& value);
  void set_user_query(std::string&& value);
  void set_user_query(const char* value);
  void set_user_query(const char* value, size_t size);
  std::string* mutable_user_query();
  std::string* release_user_query();
  void set_allocated_user_query(std::string* user_query);
  private:
  const std::string& _internal_user_query() const;
  void _internal_set_user_query(const std::string& value);
...
inline void GetResponseRequest_GetResponseConfig::set_api_auth_token(const std::string& value) {
  _internal_set_api_auth_token(value);
...
inline std::string* GetResponseRequest_GetResponseConfig::mutable_api_auth_token() {
  ...
  return _internal_mutable_api_auth_token();
}
inline const std::string& GetResponseRequest_GetResponseConfig::_internal_api_auth_token() const {
  return api_auth_token_.Get();
}
inline void GetResponseRequest_GetResponseConfig::_internal_set_api_auth_token(const std::string& value) {
  
  api_auth_token_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void GetResponseRequest_GetResponseConfig::set_api_auth_token(std::string&& value) {
  
  api_auth_token_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:service.GetResponseRequest.GetResponseConfig.api_auth_token)
}
inline void GetResponseRequest_GetResponseConfig::set_api_auth_token(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  api_auth_token_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:service.GetResponseRequest.GetResponseConfig.api_auth_token)
}
inline void GetResponseRequest_GetResponseConfig::set_api_auth_token(const char* value,
    size_t size) {
  
  api_auth_token_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:service.GetResponseRequest.GetResponseConfig.api_auth_token)
}
inline std::string* GetResponseRequest_GetResponseConfig::_internal_mutable_api_auth_token() {
  
  return api_auth_token_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* GetResponseRequest_GetResponseConfig::release_api_auth_token() {
  ...
  return api_auth_token_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void GetResponseRequest_GetResponseConfig::set_allocated_api_auth_token(std::string* api_auth_token) {
  ...
  api_auth_token_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), api_auth_token,
      GetArena());
...
inline int GetResponseRequest_GetResponseConfig::_internal_narrative_template_keys_size() const {
  return narrative_template_keys_.size();
}
...
GetResponseRequest_GetResponseConfig::_internal_narrative_template_keys() const {
  return narrative_template_keys_.GetMap();
}
inline const ::PROTOBUF_NAMESPACE_ID::Map< std::string, std::string >&
...
GetResponseRequest_GetResponseConfig::_internal_mutable_narrative_template_keys() {
  return narrative_template_keys_.MutableMap();
}
inline ::PROTOBUF_NAMESPACE_ID::Map< std::string, std::string >*
...
inline bool GetResponseResponse_AudioResponse::_internal_has_face_emotion() const {
  return this != internal_default_instance() && face_emotion_ != nullptr;
}
...
inline const ::service::ARKitBlendShapesData& GetResponseResponse_AudioResponse::_internal_face_emotion() const {
  const ::service::ARKitBlendShapesData* p = face_emotion_;
...
inline void GetResponseResponse_AudioResponse::unsafe_arena_set_allocated_face_emotion(
    ::service::ARKitBlendShapesData* face_emotion) {
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(face_emotion_);
  }
  face_emotion_ = face_emotion;
  if (face_emotion) {
...
inline ::service::ARKitBlendShapesData* GetResponseResponse_AudioResponse::release_face_emotion() {
  ...
  ::service::ARKitBlendShapesData* temp = face_emotion_;
...
inline ::service::ARKitBlendShapesData* GetResponseResponse_AudioResponse::_internal_mutable_face_emotion() {
  ...
  if (face_emotion_ == nullptr) {
    auto* p = CreateMaybeMessage<::service::ARKitBlendShapesData>(GetArena());
    face_emotion_ = p;
  }
  return face_emotion_;
}
inline ::service::ARKitBlendShapesData* GetResponseResponse_AudioResponse::mutable_face_emotion() {
  ...
  return _internal_mutable_face_emotion();
}
inline void GetResponseResponse_AudioResponse::set_allocated_face_emotion(::service::ARKitBlendShapesData* face_emotion) {
  ...
  if (face_emotion) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(face_emotion)->GetArena();
    if (message_arena != submessage_arena) {
...
inline bool GetResponseResponse_AudioResponse::_internal_has_emotion_response() const {
  return this != internal_default_instance() && emotion_response_ != nullptr;
}
...
inline const ::service::EmotionResponse& GetResponseResponse_AudioResponse::_internal_emotion_response() const {
  const ::service::EmotionResponse* p = emotion_response_;
...
inline void GetResponseResponse_AudioResponse::unsafe_arena_set_allocated_emotion_response(
    ::service::EmotionResponse* emotion_response) {
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(emotion_response_);
  }
  emotion_response_ = emotion_response;
  if (emotion_response) {
...
inline ::service::EmotionResponse* GetResponseResponse_AudioResponse::release_emotion_response() {
  ...
  ::service::EmotionResponse* temp = emotion_response_;
  emotion_response_ = nullptr;
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
...
inline ::service::EmotionResponse* GetResponseResponse_AudioResponse::_internal_mutable_emotion_response() {
  ...
  if (emotion_response_ == nullptr) {
    auto* p = CreateMaybeMessage<::service::EmotionResponse>(GetArena());
    emotion_response_ = p;
  }
  return emotion_response_;
}
...
inline void GetResponseResponse_AudioResponse::set_allocated_emotion_response(::service::EmotionResponse* emotion_response) {
  ...
  if (emotion_response) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(emotion_response);
    if (message_arena != submessage_arena) {
...
inline void EmotionResponse::set_emotion(const std::string& value) {
...
inline void EmotionResponse::_internal_set_emotion(const std::string& value) {
  ...
  emotion_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void EmotionResponse::set_emotion(std::string&& value) {
  
  emotion_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:service.EmotionResponse.emotion)
}
inline void EmotionResponse::set_emotion(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  emotion_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:service.EmotionResponse.emotion)
}
inline void EmotionResponse::set_emotion(const char* value,
    size_t size) {
  
  emotion_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:service.EmotionResponse.emotion)
}
inline std::string* EmotionResponse::_internal_mutable_emotion() {
  
  return emotion_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* EmotionResponse::release_emotion() {
  // @@protoc_insertion_point(field_release:service.EmotionResponse.emotion)
  return emotion_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void EmotionResponse::set_allocated_emotion(std::string* emotion) {
  ...
  emotion_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), emotion,
      GetArena());
...
inline void EmotionResponse::set_scale(const std::string& value) {
...
inline void EmotionResponse::set_scale(std::string&& value) {
  
  scale_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:service.EmotionResponse.scale)
}
inline void EmotionResponse::set_scale(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  scale_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:service.EmotionResponse.scale)
}
inline void EmotionResponse::set_scale(const char* value,
    size_t size) {
  ...
  scale_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:service.EmotionResponse.scale)
}
...
inline std::string* EmotionResponse::release_scale() {
  ...
  return scale_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline void FeedbackRequest::set_user_query(const std::string& value) {
  _internal_set_user_query(value);
...
inline const std::string& FeedbackRequest::_internal_user_query() const {
  return user_query_.Get();
}
inline void FeedbackRequest::_internal_set_user_query(const std::string& value) {
  
  user_query_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void FeedbackRequest::set_user_query(std::string&& value) {
  
  user_query_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:service.FeedbackRequest.user_query)
}
inline void FeedbackRequest::set_user_query(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  user_query_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:service.FeedbackRequest.user_query)
}
inline void FeedbackRequest::set_user_query(const char* value,
    size_t size) {
  
  user_query_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:service.FeedbackRequest.user_query)
}
inline std::string* FeedbackRequest::_internal_mutable_user_query() {
  
  return user_query_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* FeedbackRequest::release_user_query() {
  ...
  return user_query_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void FeedbackRequest::set_allocated_user_query(std::string* user_query) {
  ...
  user_query_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), user_query,
      GetArena());
...
inline void FeedbackRequest::set_response(const std::string& value) {
...
inline void FeedbackRequest::set_response(std::string&& value) {
  
  response_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:service.FeedbackRequest.response)
}
inline void FeedbackRequest::set_response(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  response_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:service.FeedbackRequest.response)
}
inline void FeedbackRequest::set_response(const char* value,
    size_t size) {
  ...
  response_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:service.FeedbackRequest.response)
}
